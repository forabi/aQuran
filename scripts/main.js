...
var __slice=[].slice;app.factory("IDBStoreFactory",["$q","$http","$log","QueryBuilder","Preferences",function(e,r,n,t,o){return function(a,s){var u,i,f,c,l,m,d;return d=!1,s=_.defaults(s,{dbVersion:1,storePrefix:"",transforms:[],transformResponse:function(e){return e.data}}),i=e.defer(),c=function(){return i.notify({action:"STORE.FETCHING",data:{storeName:s.storeName}}),r.get(a,{cache:!0}).then(s.transformResponse)},u=function(){var r;return r=e.defer(),m.clear(function(){return r.resolve()},function(e){return n.error(e),r.reject(e)}),r.promise},l=function(r){var t;return i.notify({action:d?"STORE.UPDATING":"STORE.INSERTING",data:{storeName:s.storeName}}),t=e.defer(),m.putBatch(r,function(){return n.info("Data inserted."),o[""+s.storeName+"-version"]=s.dbVersion,t.resolve(m)},function(e){return t.reject(e)}),t.promise},f=function(e){return{find:function(){var r,n;return r=1<=arguments.length?__slice.call(arguments,0):[],(n=t(e,s.transforms)).find.apply(n,r)},findOne:function(){var r,n;return r=1<=arguments.length?__slice.call(arguments,0):[],(n=t(e,s.transforms)).findOne.apply(n,r)},findById:function(){var r,n;return r=1<=arguments.length?__slice.call(arguments,0):[],(n=t(e,s.transforms)).findById.apply(n,r)},findOneById:function(){var r,n;return r=1<=arguments.length?__slice.call(arguments,0):[],(n=t(e,s.transforms)).findOneById.apply(n,r)},where:function(){var r,n;return r=1<=arguments.length?__slice.call(arguments,0):[],(n=t(e,s.transforms)).where.apply(n,r)}}},m=new IDBStore(s),m.onStoreReady=function(){var e;return e=o[""+s.storeName+"-version"],e=e?Number(e):-1,e>-1&&(d=!0),Number(o[""+s.storeName+"-version"]===s.dbVersion)?i.resolve(m):e>s.dbVersion?u().then(c).then(l).then(i.resolve):c().then(l).then(i.resolve)},m.onError=function(e){return i.reject(e)},i.promise.then(f)}}]);
var __slice = [].slice;
...
app.filter("progress",[function(){var e;return e={"STORE.FETCHING":"Loading ${storeName} database from the server...","STORE.INSERTING":"Storing ${storeName} for offline use...","STORE.UPDATING":"Updating ${storeName} database..."},function(a){return _.template(e[a.action],a.data)}}]);
...
app.service("ContentService",["IDBStoreFactory","ExplanationFactory","AudioSrcFactory","Preferences","$q","$log",function(n,e,r,a,t,i){return n("resources/quran.json",{dbVersion:7,storeName:"ayas",keyPath:"gid",autoIncrement:!1,indexes:[{name:"gid",unique:!0},{name:"page_id"},{name:"sura_id"},{name:"aya_id"},{name:"standard"}],transforms:[function(n){return n.sura_name=n[a.reader.sura_name],n.text=function(){switch(!1){case!!a.reader.diacritics:return n.standard;case!(a.reader.standard_text&&a.reader.diacritics):return n.standard_full;default:return n.uthmani}}(),n},function(n){return a.explanations.enabled?t.all(a.explanations.ids.map(function(r){return e(r,n.gid)})).then(function(e){return n.explanations=e,n}):t.when(n)},function(n){return n.then(function(n){return a.audio.enabled?r(n.sura_id,n.aya_id).then(function(e){return n.recitation=e,n}):n})}]})["catch"](function(n){return i.error(n)})}]);
app.service("ExplanationService",["IDBStoreFactory","$log",function(n,e){var r,t;return r=[],t=n("resources/translations.json",{dbVersion:3,storeName:"explanations",keyPath:"id",autoIncrement:!1,indexes:[{name:"id",unique:!0},{name:"country"},{name:"language"}]}),{properties:t,load:function(o){return r["trans:"+o]||(r["trans:"+o]=t.then(function(n){return n.findOne({id:o}).exec()}).then(function(e){return n("resources/translations/"+e.file,{transformResponse:function(n){return n.data.split(/\n/g).map(function(n,e){return{gid:e+1,text:n}})},dbVersion:e.version||1,storeName:o,keyPath:"gid",autoIncrement:!1,indexes:[{name:"gid",unique:!0}],transforms:[function(n){return _.extend(n,e)}]})}).then(function(n){return e.debug("Store ready for explanation "+o),n})["catch"](function(n){return e.error(n)}))}}}]);
