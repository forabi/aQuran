...
app.service("AppCacheManager",["$window","$rootScope",function(n){return n.applicationCache.onchecking=function(n){return $log.info("AppCache Checking...",n)},n.applicationCache.onupdateready=function(n){return $log.info("AppCache Update Ready",n)},n.applicationCache.onobsolete=function(n){return $log.info("AppCache Obsolete",n)},n.applicationCache.ondownloading=function(n){return $log.info("AppCache Downloading...",n)},n.applicationCache.onprogress=function(n){return $log.info("AppCache in progress",n)},n.applicationCache.onerror=function(n){return $log.error("AppCache Error",n)},n.applicationCache.oncached=function(n){return $log.info("AppCache Cached",n)},n.applicationCache}]);
