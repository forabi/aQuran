...
##المشكلات الحالية
* أحتاج إلى خط عربي ملائم لعرض النصوص القرآنية ومتوفر برخصة حرّة وبصورة خط ويب (Web font)، من الضروري أن لا يُغير الخط شكل الحرف عند إضافة الحركات إليه، لأن تلوين الحركات وعلامات الوقف يعتمد على إضافة طبقتين من النص ثم نص الآية فوقهما، ويجب أن تتوافق مواضع الحروف تماماً. لم أجد رخصة الخط المستخدم (اسمه Nabi) حالياً أو صيغة خط ويب منه.
